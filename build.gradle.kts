...
plugins {
    ...
    id(Plugins.Path.JetBrainKotlinAndroid) version Plugins.Version.JETBRAINS_KOTLIN_ANDROID apply false
    ...
    id(Plugins.Path.KotlinJvm) version Plugins.Version.JETBRAINS_KOTLIN_ANDROID apply false
}
